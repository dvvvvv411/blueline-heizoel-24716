...
const Preise = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEO
        title="Heizöl Preise & Konditionen | Ab 70 Cent/L | NW-Heizöl"
        ...
        keywords="Heizöl Preise, Heizöl Kosten, Preisgarantie, transparente Preise, Heizöl günstig kaufen, Frankfurt am Main, Hessen"
        canonicalUrl="https://nw-heizoel.de/preise"
      />
      <Header />
