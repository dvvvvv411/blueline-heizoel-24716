...
const USPSection = () => {
  ...
  const stats = [
    ...
    { icon: MapPin, value: "50M+", label: "Liter geliefert", color: "text-red-700" },
  ...
  return (
    <section className="py-24 bg-gradient-to-b from-red-50/30 to-white relative overflow-hidden">
      {/* Background Pattern */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_50%,rgba(209,5,12,0.06),transparent)]"></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-20 animate-fade-in">
          ...
          <h2 className="text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Warum <span className="gradient-text">NW-Heizöl</span>?
          </h2>
