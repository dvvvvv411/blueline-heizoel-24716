...
const TrustSection = () => {
  ...
  return (
    <section className="py-24 bg-gradient-to-b from-white to-red-50/30 relative overflow-hidden">
      {/* Background Elements */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_30%,rgba(220,38,38,0.08),transparent)]"></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-20 animate-fade-in">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            NW-Heizöl beliefert über 100.000 zufriedene Kunden in ganz Deutschland. 
