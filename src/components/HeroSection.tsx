  ...
  return (
    <section className="bg-gradient-to-br from-gray-50 to-white relative overflow-hidden pt-32 pb-16">
      ...
      <div 
        ...
        style={{
          background: 'radial-gradient(circle, rgba(209,5,12,0.12) 0%, rgba(209,5,12,0.06) 40%, transparent 70%)',
          filter: 'blur(60px)',
        }}
      ></div>
      ...
      <div 
        ...
        style={{
          background: 'radial-gradient(circle, rgba(209,5,12,0.1) 0%, rgba(209,5,12,0.04) 35%, transparent 65%)',
          filter: 'blur(70px)',
        }}
      ></div>
      ...
      <div 
        ...
        style={{
          background: 'radial-gradient(circle, rgba(220,38,38,0.08) 0%, rgba(209,5,12,0.03) 45%, transparent 70%)',
          filter: 'blur(80px)',
        }}
      ></div>
      ...
      <div 
        ...
        style={{
          background: 'radial-gradient(circle, rgba(220,38,38,0.09) 0%, transparent 60%)',
          filter: 'blur(50px)',
          animationDelay: '3s'
        }}
      ></div>
      ...
      <div 
        ...
        style={{
          background: 'radial-gradient(circle, rgba(209,5,12,0.07) 0%, rgba(220,38,38,0.04) 50%, transparent 70%)',
          filter: 'blur(65px)',
          animationDelay: '5s'
        }}
      ></div>
